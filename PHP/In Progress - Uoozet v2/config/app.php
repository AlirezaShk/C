...
define("ACCESS_LEVEL__HIDDEN_SITE_SECTIONS", 100);

define("CONFIG__NAVBAR_DISPLAY_HOME", true);
define("CONFIG__NAVBAR_DISPLAY_CINEMA", false);
define("CONFIG__NAVBAR_DISPLAY_AUDIO_BOOK", false);
define("CONFIG__NAVBAR_DISPLAY_RADIO_MUSIC", true);
define("CONFIG__NAVBAR_DISPLAY_ARTICLES", true);
define("CONFIG__NAVBAR_DISPLAY_TV", true);
define("CONFIG__NAVBAR_DISPLAY_VIDEO_SHARE", true);

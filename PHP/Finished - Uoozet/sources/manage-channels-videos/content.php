...
//	    if($video->owner->admin != 1)continue;
	    $final .= PT_LoadPage('manage-channels-videos/list', array(
	        'ID' => $video->owner->id,
...
$pt->page_url_ = $pt->config->site_url.'/manage-channels-videos';
$pt->page = 'manage-channels-video';
$pt->videos  = $videos;
$pt->title = $lang->manage_videos . ' | ' . $pt->config->title;
$pt->description = $pt->config->description;
$pt->keyword = $pt->config->keyword;
$pt->content = PT_LoadPage('manage-channels-videos/content', array('VIDEOS' => $final));
...
$pages = array(
    ...
    'manage-musics',
    'manage-radios',
    'manage-musics-category',
    'manage-radios-category',
    'manage-channels-videos',
    'import-from-youtube',
                ...
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'general-settings' || $page == 'site-settings' || $page == 'payment-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 's3') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li <?php echo ($page == 'manage-seo-data') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-seo-data'); ?>">Manage Seo Data</a>
                            </li>
                    ...
                    <li <?php echo ($page == 'manage-musics') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">video_library</i>
                            <span>Musics & Radios</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-musics') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-musics'); ?>">Manage Music</a>
                            </li>
                            <li <?php echo ($page == 'manage-musics-category') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-musics-category'); ?>">Manage music category</a>
                            </li>
                            <li <?php echo ($page == 'manage-radios') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-radios'); ?>">Manage Radios</a>
                            </li>
                            <li <?php echo ($page == 'manage-radios-category') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-radios-category'); ?>">Manage radio category</a>
                            </li>
                        </ul>
                    </li>
                    <li <?php echo ($page == 'manage-channels-videos' || $page == 'manage-channels') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">video_library</i>
                            <span>Channels</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-channels-videos') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-channels-videos'); ?>">Manage Channels Videos</a>
                            </li>
                            <li <?php echo ($page == 'add-channels') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('add-channels'); ?>">Add Channels</a>
                            </li>
                             <li <?php echo ($page == 'manage-channels') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-channels'); ?>">Manage Channels</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-singers' || $page == 'create-singer' || $page == 'edit-singer') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">library_books</i>
                            <span>Singers</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'create-singer') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('create-singer'); ?>">Add New Singer</a>
                            </li>
                            <li <?php echo ($page == 'manage-singers') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-singers'); ?>">Manage Singer</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-alboums') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">more_vert</i>
                            <span>Alboums</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-alboums') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-alboums'); ?>">Manage Alboums</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-reports') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'manage-reports') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-reports'); ?>">Manage Reports</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'send-notify') ? 'class="active"' : ''; ?>>
                        <a href="<?php echo PT_LoadAdminLinkSettings('send-notify'); ?>">

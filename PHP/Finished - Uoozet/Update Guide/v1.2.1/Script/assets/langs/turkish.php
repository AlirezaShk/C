...
$lang_array      = array(
    ...
    'u_are_verified' => 'Tebrikler, doğrulanmışsın. Kimliğinizi doğruladığınız için teşekkür ederiz',
    'verif_request_received' => 'Talebiniz alındı ve onay bekliyor',
    'upload_id' => 'Pasaport veya Kimliği Yükle',
    'select_id' => 'Lütfen pasaportunuzun veya kimlik numaranızın son bir resmini seçin',
    'choose_file' => 'Dosya seçin',
    'submit_request' => 'İstek gönderin',
    'submit_verif_request_error' => 'Önceki istekler kabul / reddedilene kadar doğrulama isteği gönderemezsiniz.',
    'ivalid_last_name' => 'Soyadı çok uzun!',
    'ivalid_image_file' => 'Resim dosyası geçerli değil. Geçerli bir resim seçin!',
    'ivalid_id_file' => 'Pasaport / kimlik resmi bir resim olmalıdır.',
    'verif_request_sent' => 'Talebiniz başarıyla gönderildi ve yakın gelecekte yeniden incelenecek!',
    'unknown_error' => 'Hata: Bilinmeyen bir hata oluştu. Lütfen daha sonra tekrar deneyiniz',
    'ivalid_thumb_file' => 'Küçük resim dosyası geçersiz. Lütfen geçerli bir resim seçin',
    'hide' => 'Saklamak',
    'message' => 'Mesaj',
);

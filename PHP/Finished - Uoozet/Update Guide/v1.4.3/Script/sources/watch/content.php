...
$related_videos    = $db->rawQuery("SELECT * FROM " . T_VIDEOS . " WHERE MATCH (title) AGAINST ('$query_video_title') AND id <> '{$get_video->id}' $not_in_query ORDER BY `id` DESC LIMIT 20");

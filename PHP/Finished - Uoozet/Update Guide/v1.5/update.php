...
if (!empty($_POST['update_langs'])) {
    ...
    foreach ($data as $key => $value) {
        ...
        if ($value == 'arabic') {
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'القنوات الشعبية');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Populaire kanalen');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Chaînes populaires');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Beliebte Kanäle');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Популярные каналы');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Canales populares');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Popüler Kanallar');
            ...
            $lang_update_queries[] = PT_UpdateLangs($value, 'tv', 'Popular Channels');
...
var queries = [
    ...
    "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'who_sell', 'users');",
     ...
     "INSERT INTO `config` (`id`, `name`, `value`) VALUES (NULL, 'tv', 'on');",
    ...
    "INSERT INTO `langs` (`id`, `lang_key`) VALUES (NULL, 'tv')",
